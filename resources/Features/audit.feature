@UC_05 @Audit
Feature: Charge Review and Auditing
  ...
  Scenario: Validate user can modify a claim marked as Ready to Bill before generating the bill
    ...
    And I remember the added service code "56223-00" for audit verification
  ...
  #   And I click on Mark As Ready To Bill button
  #   And I wait "2" seconds
  #   # Step 2 — Reopen visit from Patient Access Checked-in Visits list
